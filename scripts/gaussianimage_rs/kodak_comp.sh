...
--model_path /ssd/huanxiong/gsimage/checkpoints_v2/kodak/GaussianImage_RS_50000_$num_points
done
...
--data_name kodak --model_name GaussianImage_RS --num_points $num_points --iterations 50000 \
--model_path /ssd/huanxiong/gsimage/checkpoints_quant_v2/kodak/GaussianImage_50000_RS_$num_points
done
