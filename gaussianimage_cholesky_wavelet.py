...
class GaussianImage_Cholesky_Wavelet(nn.Module):
    def __init__(self, loss_type="L2", **kwargs):
        ...
        self._frequencies = nn.Parameter(torch.rand(self.init_num_points, 2)) # add frequencies on x and y directions
        ...
        if self.quantize:
            ...
            #self.frequencies_quantizer = FakeQuantizationHalf.apply # LTM(Left to Modify)
