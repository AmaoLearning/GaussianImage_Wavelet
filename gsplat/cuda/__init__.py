...
wavelet_rasterize_sum_forward = _make_lazy_cuda_func("wavelet_rasterize_sum_forward")
rasterize_sum_backward = _make_lazy_cuda_func("rasterize_sum_backward")
wavelet_rasterize_sum_backward = _make_lazy_cuda_func("wavelet_rasterize_sum_backward")